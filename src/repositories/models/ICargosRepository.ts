...
type CreateCargoData = Pick<Cargo, 'tipo' | 'descricao' | 'intervaloProgressao' | 'nivelCargoId'>;
type UpdateCargoData = Pick<Cargo, 'id' | 'tipo' | 'descricao' | 'intervaloProgressao' | 'nivelCargoId'>;
